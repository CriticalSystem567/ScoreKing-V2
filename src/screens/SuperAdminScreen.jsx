          ...
          <div key={p.username} style={{
            ...
            <div>
              <div style={{ fontWeight: 700, fontSize: 14, color: theme.text }}>
                ...
                {p.room_code && <span style={{ fontSize: 10, background: "rgba(124,109,250,.2)", color: theme.accentLight, padding: "2px 7px", borderRadius: 10, marginLeft: 6 }}>HOSTS A ROOM</span>}
              </div>
