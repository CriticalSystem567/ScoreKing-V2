...
function cardPatternBg(color, strokeOpacity = 0.05, fillOpacity = 0.07) {
  const svg = `
<svg xmlns='http://www.w3.org/2000/svg' width='240' height='240'>
  <g fill='none' stroke='${color}' stroke-width='1.6' opacity='${strokeOpacity}'>
  ...
  <g fill='${color}' opacity='${fillOpacity}' font-family='Georgia, serif' font-weight='700'>
  ...
  <text x='90' y='36' font-size='22' opacity='${strokeOpacity}' transform='rotate(15 100 26)'>🃏</text>
</svg>`.trim();
...
export function getStyles(t) {
  return {
    ...
    appWrap:     { backgroundColor:t.bg,backgroundImage:cardPatternBg(t.text,0.03,0.045),backgroundRepeat:"repeat",backgroundSize:"240px 240px",minHeight:"100vh",padding:"16px 14px",maxWidth:480,margin:"0 auto",position:"relative" },
